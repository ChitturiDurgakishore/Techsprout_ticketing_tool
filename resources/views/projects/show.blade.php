        ...
        <div class="flex items-center gap-4 flex-wrap">
            ...
            <div class="flex gap-2">
                ...
                @if(request()->anyFilled(['search', 'status', 'priority']))
                    <a href="{{ route('projects.show', $project) }}" class="btn btn-danger" style="padding: 10px;">✕</a>
                @endif
            </div>
        </div>
    </form>
...
<div class="card" style="padding: 0; overflow: hidden;">
                            ...
                            <td>
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if($ticket->screenshot)
                                        <span style="font-size: 0.7rem; color: var(--text-light);">📎 Screenshot</span>
                                    @endif
                                </div>
                            </td>
                            <td>
    ...
    @else
        <div class="empty-state">
            ...
            <a href="{{ route('tickets.create', ['project_id' => $project->id, 'from_project' => $project->id]) }}" class="btn btn-primary" style="margin-top: 16px;">
                Create First Ticket
            </a>
        </div>
    @endif
